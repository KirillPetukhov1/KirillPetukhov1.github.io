...
#### Результат: ####
![Изображение](lab10_res/iter1.png)
...
#### Результат: ####
![Изображение](lab10_res/iter2.png)
...
#### Результат: ####
![Изображение](lab10_res/iter3.png)
...
#### Результаты: ####
1 итерация <br>
![Изображение](lab10_res/iter4.1.png) <br>
2 итерация <br>
![Изображение](lab10_res/iter4.2.png) <br>
3 итерация <br>
![Изображение](lab10_res/iter4.3.png) <br>
Аннотация для функции <br>
![Изображение](lab10_res/annot1.png)
...
#### Результаты: ####
Python, noGIL <br>
![Изображение](lab10_res/iter5.1(2_noGIL).png) <br>
Cython, noGIL <br>
![Изображение](lab10_res/iter5.2(4_noGIL).png) <br>
Python, 3.14 <br>
![Изображение](lab10_res/iter5.3(2_314).png) <br>
Cython, 3.14 <br>
![Изображение](lab10_res/iter5.4(4_314).png) <br><br>
